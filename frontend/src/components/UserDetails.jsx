...
const UserDetails = ({toggle, action}) => {
    return (
        <div className={`absolute top-0 left-0 w-[100vw] h-[100vh] bg-gray-500/90 z-100 flex justify-center items-center ${toggle ? 'visible' : 'hidden'}`}>
            <div className='bg-white min-w-[50vw] min-h-[50vh] rounded-2xl'>
                ...
                <div className='padding-x flex flex-col gap-5'>
                    <Input icon={user} name="username" label="DETAILS" placeholder="Type your username" type="text" onChange={(e) => handleChange(e)}/>
